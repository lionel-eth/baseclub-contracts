...
// File: contracts\BaseClub.sol

// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.0;
contract BaseClub is Ownable, ERC20 {
    ...
    uint256 public antiBotAmount = 100_000 * 10 ** 18;
    uint256 public numTokensAutoswap = 10_000 * 10 ** 18;
    ...
    constructor() ERC20("BASE CLUB", "BCLUB") {
        ...
        marketingAddress = address(0xcA01C8A6d1031694956ae1E86D8A376d0b155500);
    ...
    function addPair(address pair) public onlyOwner returns (bool) {
        require(pair != address(0), "BASECLUB: pair is the zero address");
    ...
    function getPair(uint256 index) public view returns (address) {
        require(index <= _listPairs.length() - 1, "BASECLUB: index out of bounds");
